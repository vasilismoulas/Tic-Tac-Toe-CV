...
from element.Element import Tsymbol, IElement
...
def ui() -> None:
 ...
 # Load images
 table = pygame.image.load("./tic_tac_toe_api/app/src/frontend/src/ui/assets/table.png").convert_alpha()
 circle = pygame.image.load("./tic_tac_toe_api/app/src/frontend/src/ui/assets/circle.png").convert_alpha()
 cross = pygame.image.load("./tic_tac_toe_api/app/src/frontend/src/ui/assets/cross.png").convert_alpha()
 ...
 while start:
    ...
    if len(lmsList)!=0:
       ...
       if cross.get_rect().collidepoint(lmcoordinates):
           print("cross's rectangle position: ", cross.get_rect())
    ...
    window.blit(cross, (width/2 - cross.get_width()/2, height/2 - cross.get_height()/2))
